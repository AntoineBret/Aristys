...
public class Constants {
  ...
  public interface menu_drawer {
    public static final long defaultProfile = 1;
    public static final long profileRemoveID = 2;
    public static final long profileAddID = 3;
    public static final long blog = 4;
    public static final long business = 5;
    public static final long work = 6;
    public static final long partnair = 7;
    public static final long contact = 8;
    public static final long twitter = 9;
    public static final long facebook = 10;
    public static final long linkedin = 11;
  }

  public interface preference {
  public static final String preferenceKey = "PREFERENCE";
  public static final String preferenceFirstRun = "isfirstfrun";
}
}
