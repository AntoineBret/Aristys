...
import java.util.List;
    ...
    private void handleSignInResult(@NonNull Task<GoogleSignInAccount> completedTask) {
        ...
        try {
            ...
            /*
            Intent intent = new Intent(GoogleActivity.this, NavDrawerActivity.class);
    ...
    private static class GetContactsTask extends AsyncTask<Account, Void, List<Person>> {
        ...
        private WeakReference<GoogleActivity> mActivityRef;

        public GetContactsTask(GoogleActivity activity) {
